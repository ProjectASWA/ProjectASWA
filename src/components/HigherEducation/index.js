  ...
  return (
    <div className="higher-education-main-container">
      ...
      <p className="higher-education-description">
        ...
        environmental degradation. The Center for Holistic Development of Human
        Consciousness (CHDHC), founded in 2018, advocates for inner exploration
        and connection. Through Universal Human Values education (Jeevan Vidya),
        CHDHC offers experiential workshops guiding individuals towards
        self-discovery and purpose. Spearheaded by Late Sri A. Nagaraj, CHDHC
        champions interconnectedness as the essence of reality, fostering
        harmony across individuals and nature. Empowering individuals regardless
