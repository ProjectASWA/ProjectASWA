...
const DonateProject = () => {
  ...
  const targetRefs = [useRef(null), useRef(null), useRef(null), useRef(null), useRef(null), useRef(null)];
  ...
  return (
    <div className="donateContainer">
      <div>
        <img className="bloodImage" src="/Images/bloodImage.jpg" alt="donate Image" />
      </div>
      <div className='bloodContainerText'>
        <h1 className='main-blood-heading'>Blood Connect</h1>
        <p className='main-sub-heading'>An initiative of Amma Social Welfare Association</p>
      ...
      <div className="bloodDonateArrange">
        <div className='bloodDonateContents'>
          ...
          <p className='donate-para'>When there is a patient in emergency need of blood, Blood connect tries to find a donor.</p>
        </div>
        <div className='donateImageContainer'>
          <img className="imageBloodStyling" src="/Images/bloodImage2.jpg" alt="donate Image" />
        </div>
        {showElement && (
          <div class = "mobileParaDonate">
            <p className='donate-para mobile-donate-para'>When there is a patient in emergency need of blood, Blood connect tries to find a donor.</p>
          </div>
        )}
      </div>
      ...
      <div class="main-div">
        <div class="arrange-in-row">
          ...
          <div className='donateDetailsHowWeDoIt'>
            ...
            <p className="donate-para-2">Call patient attendees to confirm details.</p>
          </div>
        </div>
        <div id = "firstBackgroundElement" class="arrange-in-row" >
          ...
          <div className='donateDetailsHowWeDoIt'>
            ...
            <p className="donate-para-2">Filter potential donors by location and blood group,then contact them</p>
          </div>
        </div>
        <div id = "secondBackgroundElement" class="arrange-in-row" >
          ...
          <div className='donateDetailsHowWeDoIt'>
            ...
            <p className="donate-para-2">Share contact information between patient and donor</p>
          </div>
        </div>
        <div id = "thirdBackgroundElement" class="arrange-in-row" >
          ...
          <div className='donateDetailsHowWeDoIt'>
            ...
            <p className="donate-para-2">Follow up after 10 days to ensure everything went smoothly and gather feedback. Request further support if needed.</p>
          </div>
        </div>
      </div>
      <div>
        <div className="FeedBackContainer">
          <div className='feedBackContents'>
            ...
            <p className='feedBackPara'>12000+ blood donations facilitated across 49 blood donation camps</p>
          </div>
